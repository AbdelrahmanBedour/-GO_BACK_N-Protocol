...
int main()
{
    /* Every packet has a number equals to its index */
    for(int i=0;i<=MAX_SEQ;i++)
    {
        network_packets[i].data[0] = i;
    }
    ...
    /* Connecting The Master Through Socket*/
    Connect_Master();
    ...
    while (true)
    {
            ...
            switch(event)
            {
                ...
                cout<<"Getting New Packet From Network Layer!"<<endl;
                ...
                cout<<"A New Frame Arrived From Physical Layer!"<<endl;
                cout<< "Ack For Frame " << r.ack << " Is Received!"<<endl;
                ...
                cout<<"Timerout"<<endl;
                next_frame_to_send = ack_expected; /* start retransmitting from last message did not
                receive ack */
                  ...
                  for(int i=0;i<MAX_SEQ;i++)
                    {
                            if(t.flag[i]==true)
                            {
                                ...
                                if (t.count[i]==10&&timeout_flag==0)
                                {
                                    ...
                                    cout<< "Time is Out For Frame " <<i<<endl;
